# -*- coding: utf-8 -*-
"""VRFT_PID_haifu.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16OCiHH57q6PAu1kRyBPHaxId3WPqTk1q
"""

# データ駆動制御プログラム：PID調整
# 作成日2022/11/17(自称AI・制御エンジニア)
# 更新日2022/11/17(自称AI・制御エンジニア)

#!pip install slycot control # python controlインストール(初回のみ)
import numpy as np
...
df = pd.read_csv('test_data_2st.csv') # 入出力応答の読み込み(二次遅れ)
#df = pd.read_csv('test_data_1st.csv') # 入出力応答の読み込み(一次遅れ)
